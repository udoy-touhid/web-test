...
public final class CustomWebViewAssetLoader {
   ...
   public interface PathHandler {
       ...
       * In this case, {@link androidx.webkit.WebViewAssetLoader} will try the next handler registered on this
   ...
   /*package*/ static class PathMatcher {
      ...
      @NonNull final androidx.webkit.WebViewAssetLoader.PathHandler mHandler;
       ...
       * @param handler the {@link androidx.webkit.WebViewAssetLoader.PathHandler} the handler class for this URI.
       */
      PathMatcher(@NonNull final String authority, @NonNull final String path,
                  boolean httpEnabled, @NonNull final androidx.webkit.WebViewAssetLoader.PathHandler handler) {
      ...
      @WorkerThread
      @Nullable
      public androidx.webkit.WebViewAssetLoader.PathHandler match(@NonNull Uri uri) {
   ...
   /**
    * A builder class for constructing {@link androidx.webkit.WebViewAssetLoader} objects.
    */
   public static final class Builder {
      ...
      @NonNull private final List<Pair<String, androidx.webkit.WebViewAssetLoader.PathHandler>> mHandlerList = new ArrayList<>();
       ...
       * @return {@link androidx.webkit.WebViewAssetLoader.Builder} object.
       */
      @NonNull
      ...
      /**
       * Register a {@link androidx.webkit.WebViewAssetLoader.PathHandler} for a specific path.
       * <p>
       ...
       * @param handler {@link androidx.webkit.WebViewAssetLoader.PathHandler} that handles requests for this path.
       * @return {@link androidx.webkit.WebViewAssetLoader.Builder} object.
       * @throws IllegalArgumentException if the path is invalid.
       */
      @NonNull
      public  Builder addPathHandler(@NonNull String path, @NonNull androidx.webkit.WebViewAssetLoader.PathHandler handler) {
         mHandlerList.add(Pair.create(path, handler));
         return this;
      }

      /**
       * Build and return a {@link androidx.webkit.WebViewAssetLoader} object.
       *
       * @return immutable {@link androidx.webkit.WebViewAssetLoader} object.
       */
      @NonNull
      public CustomWebViewAssetLoader build() {
         List<PathMatcher> pathMatcherList = new ArrayList<>();
         for (Pair<String, androidx.webkit.WebViewAssetLoader.PathHandler> pair : mHandlerList) {
            String path = pair.first;
            androidx.webkit.WebViewAssetLoader.PathHandler handler = pair.second;
            pathMatcherList.add(new PathMatcher(mDomain, path, mHttpAllowed, handler));
         }
         return new CustomWebViewAssetLoader(pathMatcherList);
      }
   }

   /*package*/ CustomWebViewAssetLoader(@NonNull List<PathMatcher> pathMatchers) {
   ...
   public WebResourceResponse shouldInterceptRequest(@NonNull Uri url) {
      for (PathMatcher matcher : mMatchers) {
         androidx.webkit.WebViewAssetLoader.PathHandler handler = matcher.match(url);
